...
class FFILib {
  constructor () {
    ...
    if (process.platform === "win32") {
      this._zbc = ffi.Library('../../lib/obj/libzbc-windows-4.0-amd64', ffiInterface)
    }
  
    if (process.platform === "darwin") {
        this._zbc = ffi.Library('../../lib/obj/libzbc-darwin-10.6-amd64', ffiInterface)
    } 
  
    if (process.platform === "linux") {
        this._zbc = ffi.Library('../../lib/obj/libzbc-linux-amd64', ffiInterface)
    }
