...
class FFILib {
  constructor () {
    ...
    if (process.platform === "win32") {
      this._zbc = ffi.Library(`${__dirname}/obj/libzbc-windows-4.0-amd64`, ffiInterface)
    }

    if (process.platform === "darwin") {
      this._zbc = ffi.Library(`${__dirname}/obj/libzbc-darwin-10.6-amd-64`, ffiInterface)
    } else {
      this._zbc = ffi.Library(`${__dirname}/obj/libzbc-linux-amd64`, ffiInterface)
    }
