...
class JobClient {
  ...
  _callJobWorker(topicName, workerName, jobType, lockDuration, credits) {
    const returnValue = this.zbc.CreateJobWorker(Structs.newGoString(topicName), Structs.newGoString(workerName), Structs.newGoString(jobType), lockDuration, credits);
